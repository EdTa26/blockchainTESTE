...
public class blockchainTESTE {
	...
	public static void main(String[] args) {	
		...
		genesisTransaction.outputs.add(new TransactionsOutput(genesisTransaction.reciepient, genesisTransaction.value, genesisTransaction.transactionId)); //manually add the Transactions Output
	...
	public static Boolean isChainValid() {
		...
		HashMap<String,TransactionsOutput> tempUTXOs = new HashMap<String,TransactionsOutput>(); //a temporary working list of unspent transactions at a given block state.
